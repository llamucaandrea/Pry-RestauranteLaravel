...
<div class="container-fluid">
    ...
    @endif  
    @if($datos->alm_dia==='DOMINGO' || $datos->alm_dia==='SABADO' ) 
        <div class="alert alert-warning">
            LOS DIAS SABADO Y DOMINGO NO SE CREAN ALMUERZOS
        </div>
    @else
        <p><h5>Los campos con <label style="color:#FF0000";>*</label> son obligatorios</h5></p>
        <form action="{{url('/almuerzo/update')}}" method="POST" enctype="multipart/form-data">
            <input type="hidden" name="_token" value="{{ csrf_token() }}">
            <input type="hidden" name="alm_id" value="{{ $datos->alm_id }}">
            <div class="row">
                <div class="col">
            ...
            <div class="row">
                ...
                @if($datos->alm_dia==='VIERNES')
                    <input type="hidden" name="alm_segundo2"> 
                @else
                    <div class="col">
                        <div class="form-group">
            ...
            <div class="row">
                <div class="col">
                    <div class="form-group">                        
                        ...
                        @if(isset($datos->alm_foto))
                            <div class="form-group">
                                <input type="file" class="form-control" name="alm_foto" value="{{$datos->alm_foto}}">
                                <input type="hidden" name="alm_foto1" value="{{$datos->alm_foto}}">   
                            </div>
                        @else  
                            <div class="form-group">
